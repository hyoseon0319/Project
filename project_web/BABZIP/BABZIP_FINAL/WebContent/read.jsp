<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<jsp:useBean id="resultContent" class="model.ReviewVO" scope="request" />
<HEAD>
...
<table align="center" cellpadding="5" cellspacing="2" width="600" border='1'>
    <tr>
        <td width="1220" height="20" colspan="4" bgcolor="#dd7777">
            <p align="center"><font color="white" size="3"><b>
            ${requestScope.resultContent.num}번째 이번 게시물 자세히보기</b></font></p>
        </td>
    </tr>
    <tr>
		...
		${requestScope.resultContent.name}</b></span></td>
    </tr>
    <tr>
        <td width="100" height="20">
    ...
    <tr>
		<td width="100" height="200" valign="top">
            <p align="right"><b><span style="font-size:9pt;">한줄평</span></b></p>
        </td>
		<!-- 브라우저에 글 내용을 뿌려줄 때는 개행문자(\n)가 <br>태그로 변환된 문자열을 보여줘야 한다. -->
        <td width="450" height="200" valign="top" colspan="3"><span style="font-size:9pt;"><b>
		${requestScope.resultContent.review}</b></span></td>
    </tr>
    <tr>
        <td width="100" height="20">
            <p align="right"><b><span style="font-size:9pt;">지역/ 가게 번호</span></b></p>
        </td>
        <td width="450" height="20" colspan="3"><span style="font-size:9pt;"><b>
		${requestScope.resultContent.resnum}</b></span></td>
    </tr>
    <tr>
